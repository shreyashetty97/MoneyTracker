...
public class LentDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lent_details);
        Bundle bundle = getIntent().getExtras();
        String name_id=bundle.getString("Name");
        try {
            db1 = openOrCreateDatabase("data.db", Context.MODE_PRIVATE, null);
            Cursor c = db1.rawQuery("SELECT * FROM LentTable WHERE Name=?", new String[]{name_id});
            c.moveToFirst();
        ...
        del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db1.delete("LentTable","Name" + "=?", new String[]{abc});
        ...
        upda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TextView tv=(TextView)findViewById(R.id.name);
                String abc=tv.getText().toString();
                Intent nextscreen= new Intent(getApplicationContext(),UpdateLent.class);                //change to update class !!!!
