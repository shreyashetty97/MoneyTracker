        ...
        upd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    if(flag==0)
                        db1.execSQL("INSERT INTO MoneyTable(Name,Date,Reason,Amount) VALUES("+"'"+name_id+"','"+dd+"','"+d2+"',"+d3+");");
                    else if(flag==1)
                    {
                        ...
                        db1.execSQL("INSERT INTO MoneyTable(Name,Date,Reason,Amount) VALUES("+"'"+name_id+"','"+dd+"','"+rea_f+"',"+t_amt+");");
                    }
