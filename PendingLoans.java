...
public class PendingLoans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(c!=null)
        {
            if(c.moveToFirst())
                do {
                    ...
                    Button bt=new Button(PendingLoans.this);
                    ViewGroup tablelayout=(ViewGroup)findViewById(R.id.table3);
                    bt.setText(temp);
                    TextView tv=new TextView(PendingLoans.this);
                    tv.setText(d1);
                   ...
                   // registerForContextMenu(bt);
                    bt.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        {
                            Intent nextscreen= new Intent(getApplicationContext(),LoanDetails.class);
        ...
        if(j==0)
        {
            noDet=new TextView(PendingLoans.this);
