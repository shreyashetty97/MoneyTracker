...
public class AddMoneyLent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_money_lent);
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try
                {
                    ...
                    if(flag==0)
                        db1.execSQL("INSERT INTO LentTable(Name,Date,Reason,Amount) VALUES("+"'"+d1+"','"+dd+"','"+d2+"',"+d3+");");
                    else if(flag==1)
                    {
                        ...
                        db1.execSQL("INSERT INTO LentTable(Name,Date,Reason,Amount) VALUES("+"'"+d1+"','"+dd+"','"+rea_f+"',"+t_amt+");");
                    }
